package com.example.hasee.transitiondemo.custom;
 ...
 */
public class ChangeSceneColor extends Transition {

    /** Key to store a color value in TransitionValues object */
    private static final String PROPNAME_BACKGROUND = "transitionnote:change_color:background";
