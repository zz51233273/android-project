package com.example.hasee.demonotification;
...
public class MediaService extends Service {
    ...
    int[] songs = {R.raw.song1,R.raw.song1};
    int playerStatus = 0;
    private int index = 0;
    ...
    private void sendCustomerNotification(int command){
        ...
        builder.setLargeIcon(BitmapFactory.decodeResource(getResources(),R.drawable.cat));
        ...
        if(command==CommandNext){
            remoteViews.setImageViewResource(R.id.btn1,R.drawable.cat);
