package com.example.hasee.mysqlitestudent;
...
public class DBHelper  extends SQLiteOpenHelper {
    ...
    public void onInit(SQLiteDatabase db) {//清空数据，并向数据库学生表中添加10名学生，初始化数据。
        ...
        String insert1="insert into " + Student.TABLE + "("+ Student.KEY_ID+","+Student.KEY_name+","+Student.KEY_age+")" + " values(?, ?, ?)";
        db.execSQL(insert1, new Object[]{101,"刘得意", 19});
        db.execSQL(insert1, new Object[]{102,"王锐", 20});
        db.execSQL(insert1, new Object[]{103,"何煜中", 19});
        db.execSQL(insert1, new Object[]{104,"王磊", 21});
        db.execSQL(insert1, new Object[]{105,"冯松", 19});
        db.execSQL(insert1, new Object[]{106,"得意刘", 19});
        db.execSQL(insert1, new Object[]{107,"锐王", 20});
        db.execSQL(insert1, new Object[]{108,"煜中何", 19});
        db.execSQL(insert1, new Object[]{109,"磊王", 21});
        db.execSQL(insert1, new Object[]{110,"松冯", 19});
